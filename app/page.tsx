...
export default function Home() {
  return (
    <div className="flex flex-col gap-0">
      ...
      <section
        aria-label="Hero"
        className="bg-gradient-to-r from-blue-50 via-white to-red-50 py-20 md:py-32 relative overflow-hidden border-b border-red-100"
      >
        <Image
          src={"/hero-image.jpg"}
      ...
      >
        <div className="container mx-auto px-4 md:px-6 text-center max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-gray-700">
            BloodLink is a modern platform connecting donors, recipients, and
            organizations to make blood donation easier, safer, and more
            impactful. Join us in saving lives and building a healthier
            community.
          </p>
        </div>
      </section>
      ...
      <section
        aria-label="Why Donate Blood"
        className="py-16 bg-gradient-to-br from-red-50 to-blue-50 border-b border-gray-100"
      >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="flex flex-col items-center p-6 text-center shadow-md">
              ...
              <p className="text-gray-600">
                Your donation can save up to three lives and make a real
            ...
            <Card className="flex flex-col items-center p-6 text-center shadow-md">
              ...
              <p className="text-gray-600">
                Support your community and help hospitals maintain a healthy
                blood supply.
              </p>
            </Card>
            <Card className="flex flex-col items-center p-6 text-center shadow-md">
              ...
              <p className="text-gray-600">
                Experience the joy of giving and receive health benefits as a
                regular donor.
              </p>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <ol className="flex flex-col md:flex-row gap-8 md:gap-0 md:justify-between items-center">
            <li className="flex flex-col items-center max-w-xs">
              <span className="bg-red-100 text-red-700 rounded-full h-12 w-12 flex items-center justify-center font-bold text-xl mb-3">
                1
              </span>
            ...
            <li className="flex flex-col items-center max-w-xs">
              <span className="bg-blue-100 text-blue-700 rounded-full h-12 w-12 flex items-center justify-center font-bold text-xl mb-3">
                2
              </span>
              <p className="font-medium mb-1">Find a Camp</p>
              <p className="text-gray-600 text-center">
                Search for nearby donation camps or events.
              </p>
            </li>
            <li className="flex flex-col items-center max-w-xs">
              <span className="bg-red-100 text-red-700 rounded-full h-12 w-12 flex items-center justify-center font-bold text-xl mb-3">
              ...
              <p className="text-gray-600 text-center">
                Attend the camp, donate, and help save lives!
              </p>
            </li>
          </ol>
        </div>
      ...
      <section
        aria-label="Upcoming Donation Camps"
        className="py-16 bg-gradient-to-br from-blue-50 to-red-50 border-b border-gray-100"
      >
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            ...
            {upcomingCamps.map((camp, idx) => (
              <Card key={idx} className="p-6 flex flex-col gap-2 shadow-md">
                ...
                <p className="text-gray-600 text-sm">
                  {camp.date} &middot; {camp.location}
                </p>
      ...
      <section
        aria-label="FAQ"
        className="py-16 bg-gradient-to-br from-blue-50 to-white border-b border-gray-100"
      >
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="q1">
              ...
              <AccordionContent>
                Most healthy adults aged 18-65 can donate blood. There are some
                medical and travel restrictions—check with your local
                guidelines.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="q2">
              ...
              <AccordionContent>
                You can typically donate whole blood every 3 months. Platelet
                and plasma donation intervals may differ.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="q3">
              <AccordionTrigger>Is blood donation safe?</AccordionTrigger>
              <AccordionContent>
                Yes! All equipment is sterile and single-use. Donors are
                carefully screened for safety.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
            ...
            {partners.map((p, idx) => (
              <div key={idx} className="flex flex-col items-center">
                <img
                  src={p.logo}
                  alt={p.name}
                  className="h-12 w-auto mb-2 grayscale hover:grayscale-0 transition-all"
                />
