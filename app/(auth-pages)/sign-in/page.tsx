...
export default async function SignIn(props: {
  ...
  return (
    <div
      className="flex w-full h-screen font-sans"
      style={{ fontFamily: "Inter, Poppins, Lato, sans-serif" }}
    >
      ...
      <div className="w-1/2 min-h-full relative flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full w-full">
          <p
            className="text-2xl md:text-3xl font-bold text-center mb-10 drop-shadow-lg bg-[#f15e5e] text-white rounded-xl py-4 px-6"
            style={{ textShadow: "0 2px 8px rgba(0,0,0,0.07), 0 0 2px #fff" }}
          >
      ...
      <div className="w-1/2 min-h-full flex flex-row items-center justify-center bg-white">
        ...
        >
          <div className="flex flex-col items-center mb-6">
            <h1
              className="text-2xl font-semibold mb-2 text-[#1f1f1f] tracking-normal"
          ...
          <div>
            <Label
              htmlFor="email"
              className="block text-sm font-medium mb-1 text-[#1f1f1f]"
            >
              Email
            </Label>
          ...
          <SubmitButton
            ...
            className="w-full rounded-lg bg-[#ef4444] hover:bg-[#dc2626] text-white font-semibold shadow-md transition"
          >
            Sign In
          </SubmitButton>
          ...
          <div className="text-center text-sm mt-6">
            ...
            <Link
              href="/sign-up"
              className="text-[#ef4444] font-medium underline hover:text-[#dc2626] transition"
            >
              Sign Up
            </Link>
          </div>
